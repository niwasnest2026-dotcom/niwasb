-- FIXED NIWASNEST DATABASE SETUP
...
CREATE TABLE IF NOT EXISTS property_rooms (
  ...
  furnishing_type TEXT DEFAULT 'Semi-Furnished',
  description TEXT,
...
CREATE TABLE IF NOT EXISTS bookings (
  ...
  guest_id_proof_type VARCHAR(50),
...
-- Create site_settings table (simplified)
...
(
  ...
  'Metro Station - 0.2km, City Mall - 0.1km, Christ University - 2km, Infosys - 5km'
),
(
  'Elite Residency',
  ...
  'Metro Station - 0.1km, Brigade Road Shopping - 0.2km, Commercial Street - 0.5km'
),
(
  'Green Valley PG',
  ...
  'Forum Mall - 1km, Koramangala Social - 0.8km, NIMHANS - 2km, Wipro - 4km'
),
(
  'Tech Hub Residency',
  ...
  'Infosys - 2km, TCS - 1.5km, Wipro - 3km, Electronic City Metro - 1km'
),
(
  'Campus Connect PG',
  ...
  'Jayanagar Metro - 0.5km, BMS College - 1km, Jayanagar Shopping Complex - 0.3km'
)
ON CONFLICT (name) DO NOTHING;
...
BEGIN
  ...
  LOOP
    ...
    (
      ...
      'Affordable 4-sharing room on the third floor. Three beds available.'
    ) ON CONFLICT (property_id, room_number) DO NOTHING;
...
('terms_and_conditions', 'By booking with us, you agree to our terms and conditions...', 'Terms and conditions'),
('privacy_policy', 'We respect your privacy and protect your personal information...', 'Privacy policy'),
