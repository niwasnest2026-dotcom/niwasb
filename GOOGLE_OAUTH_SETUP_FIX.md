...
Your app should be running on: `http://localhost:3002`
...
3. Fill required fields:
   ...
   - **App domain**: `localhost:3002` (for development)
...
**Fix**:
1. Check if your dev server is running on port 3002
2. Try `http://localhost:3002` directly in browser
...
- ✅ Provide fallback for localhost:3002
